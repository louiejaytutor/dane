...
async function ShowPostLoader() {
    posts.append(`<div id="post-loader" class="post">
        <svg preserveAspectRatio="xMidYMid meet" viewBox="0 0 187.3 93.7" style="height: 100px; width: 200px; margin: auto;">
...
async function RemovePostLoader() {
    $("#post-loader").remove();
}
